  ...
  <view class="page-pet-circle">
    ...
    <scroll-view scroll-y class="wf-scroll">
      ...
      <view v-else class="wf-grid">
        <view class="wf-col">
          <PetCircleCard v-for="c in leftCards" :key="c.id" :card="c" :height="c.h" :max-stats="maxStats" @bar-tap="onBarTap" />
        </view>
        <view class="wf-col">
          <PetCircleCard v-for="c in rightCards" :key="c.id" :card="c" :height="c.h" :max-stats="maxStats" @bar-tap="onBarTap" />
        </view>
      </view>
    </scroll-view>
  </view>
